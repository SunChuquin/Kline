...
| 差分生成耗时 | **138.4 秒**（原 **400.0 秒**，2026-09-22 优化后；见 [[20260922-全表JOIN逐行随机探查比逐文件慢10倍]]） | 1.4GB 库对全跑。优化后拆分：基线校验 ~14s + 自洽性 11.6s + 扫描出包 110.5s（daily 67.5 / weekly 25.0 / monthly 12.1 / 季 4.5 / 年 1.4）+ 复核 9.1s |
